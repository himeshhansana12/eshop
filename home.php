                    ...
                    <div id="carouselExampleCaptions" class=" col-12 carousel slide carousel-fade" data-bs-ride="carousel" style="padding: 0;">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="2500" style="background-color: antiquewhite;">
                                <img src="./resourses/slider images/WhatsApp Image 2023-09-14 at 15.27.54rrgeg.jpg" style="width: 100%;" class="d-block wsh-banner" />
                            </div>
                            <div class="carousel-item" data-bs-interval="2500">
                                <img src="./resourses/slider images/sdcsdefs.jpg" style="width: 100%;" class="d-block wsh-banner" />
                            </div>
                            <div class="carousel-item" data-bs-interval="2500">
                                <img src="./resourses/slider images/WhatsApp Image 2023-09-14 at 15.27.54cdd.jpg" style="width: 100%;" class="d-block wsh-banner" />
                            </div>
                        </div>
                            ...
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        // item gana adu vedi karana eka

                                        $product_rs = Database::search("SELECT * FROM `product` WHERE 
                                    `category_cat_id`='" . $c_data['cat_id'] . "' AND `status_status_id`='1' ORDER BY 
                                    `datetime_added` DESC LIMIT 10000000 OFFSET 0");
