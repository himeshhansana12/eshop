                        ...
                        <div class="col-12 mb-4">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <?php
                                    $u_has_address_rs = Database::search("SELECT * FROM `users_has_address` WHERE `users_email`='".$_SESSION["u"]["email"]."'");
                                    $u_has_address_data = $u_has_address_rs->fetch_assoc();
                                    ?>
                                    <span><?php echo $u_has_address_data["line1"]." ".$u_has_address_data["line2"]?></span><br />
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        ...
                                        <td>
                                            ...
                                            $curr_product_rs= Database::search("SELECT  `price`,`title`, `delivery_fee_colombo`, `delivery_fee_other` FROM `product` WHERE `id`='".$invoice_data["product_id"]."'");
                                            $curr_product_data = $curr_product_rs->fetch_assoc();


                                            $delivery = 0;
                                            if($city_data["district_id"] == 5) {

                                                $delivery = $curr_product_data["delivery_fee_colombo"];
                                            }else{
                                                $delivery = $curr_product_data["delivery_fee_other"];
                                            }
                                        ...
                                        <span class="fw-bold text-primary fs-3 p-2"><?php echo $curr_product_data["title"]?></span>
                                        </td>
                                        <td class="fw-bold fs-6 text-end pt-3 bg-secondary text-white">Rs. <?php echo $curr_product_data["price"]?> .00</td>
                                        <td class="fw-bold fs-6 text-end pt-3">0<?php echo $invoice_data["qty"]?></td>
                                        <td class="fw-bold fs-6 text-end pt-3 bg-secondary text-white">Rs. <?php echo intval($curr_product_data["price"]) * intval($invoice_data["qty"])?> .00</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">Rs. <?php echo intval($curr_product_data["price"]) * intval($invoice_data["qty"])?> .00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
